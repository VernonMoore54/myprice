...
local function ensureHamonFunds()
    while LocalPlayer.PlayerStats.Money.Value < 10000 do
        ...
        farmItem("Diamond", 10)
        farmItem("Steel Ball", 10)
        farmItem("Quinton's Glove", 10)
        farmItem("Pure Rokakaka", 10)
        farmItem("Ribcage Of The Saint's Corpse", 10)
        farmItem("Ancient Scroll", 10)
        farmItem("Clackers", 10)
        farmItem("Caesar's headband", 10)
...
local function autoStory()
    ...
    if LocalPlayer.PlayerStats.Spec.Value == "None" and LocalPlayer.PlayerStats.Level.Value >= 25 then
        ensureHamonFunds() -- Ensure we have enough funds for Hamon
